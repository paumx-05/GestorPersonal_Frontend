...
/**
 * Register Page - Página dedicada de registro
 * URL: /register
 * Features: Formulario de registro, redirección automática, link al login
 */
      ...
      <div className="max-w-md w-full">
        ...
        <div className="mt-6 p-4 bg-slate-800/50 rounded-lg border border-slate-700/50">
          <p className="text-sm text-slate-400 text-center">
            ...
            <Link href="/terms" className="text-[#FF385C] hover:text-[#E31C5F]">
              términos y condiciones
            </Link>{' '}
            y{' '}
            <Link href="/privacy" className="text-[#FF385C] hover:text-[#E31C5F]">
